...
export default class Controller {
    ...
    private updateZoneState(state: ZoneState) {
        ...
        if (state === ZoneState.Loading) {
            ...
            if (this.uiState === UIState.NotPlayingTimeout || this.uiState === UIState.DisplayOffTimeout) {
                ...
                this.logger.sendLog("Player is stopped/paused and UI is already in display off state")
                return
            }
        }
